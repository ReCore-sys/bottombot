...
def bottomchoice():
            ...
            noun1 = random.choice(["god", "your mother", "pyro from tf2", "the Queen","a 1982 Rolls Royce Silver Wraith", "the 1999 toyota corolla", "Lebron James", "a 100% legitimate nigerian prince","253 primary school students", "the entirety of europe", "the abstract concept of time","a male stripper","a toaster"])
            verb2 = random.choice(["bash", "assimilate", "make explosive love to", "commit crimes to", "alt-f4", "give heroin to", "start a crack epidemic with","whisper seductively to","bully","drink","start a pyramid scheme with","warcrimes"])
            noun2 = random.choice(["dwane the cock jhonson","5th grade stoners","ben shapiro","Mike Oxlong","you","Jehova","Heavy","[Redacted]", "Ugandan villagers","the middle east","Jimmy Neutron","allan","a cow"])
            ...
            output = "Tonight on bottomgear {james} {verb1} {noun1}, I {verb2} {noun2} and {hammond} {verb3} {noun3} and {consequence}" #this compiles a random choice from each list into one large string. Feel free to add stuff to the list.
            return str(output)
