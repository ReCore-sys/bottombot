...
def bottomchoice():
            ...
            verb2 = random.choice(["bash", "assimilate", "make explosive love to", "commit crimes to", "alt-f4", "give heroin to", "start a crack epidemic with","whisper seductively to","bully","drink","start a pyramid scheme with","time travels"])
            noun2 = random.choice(["dwane the cock jhonson","5th grade stoners","ben shapiro","Mike Oxlong","you","Jehova","Heavy","[Redacted]", "Ugandan villagers","the middle east","Jimmy Neutron","toaster","crack"])
