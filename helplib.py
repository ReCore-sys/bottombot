...
def help(cmd = None):
    ...
    "volume" : "Change the music player's volume, between 1 and 100.",
    ...
    "leave" : "If you are in the waiting list, it will remove you from it. If you are currently connected to another server it will disconnect you."},
        "Economy" : {
    "balance": "Shows the bank account of the pinged user. If none pinged will show your own.",
    "pay" : "(-pay <amount> <user>) pays <amount> from your bank account into <user>.",
    "rank"  : "(-rank [buy] <rank>) used to buy ranks. If none selected will show the price of the ranks.",
    "daily" : "earns you between $20 and $50. Has a 24 hour cooldown.",
    "leaderboard" : "Shows the top 5 economy users and your standing",
    "bounty" : "Shows current bounties. Do -bounty <bounty name> to see more info and -bounty take to take the bounty",
    "stocks" : "([buy/sell] <number to buy/sell or 'all'>) running without args shows the current stock price. Selling or buying's cost is dependant on the current price of stocks"},
        "Other" : {
    ...
    "rewind" : "Prints the most recent mention of anyone in the server and what was said.",
    "duck" : "duck",
    ...
    "dog" : "Dog",
    "mod" : "allows admins to enable and disable some parts of the bot. You will need to run -init for it to work"}
    }
    return helper
